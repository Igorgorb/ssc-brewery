...
public class BeerControllerIT extends BaseIT {
    ...
    class InitNewForm {
        ...
        @Test
        public void initCreationFormAuth() throws Exception {
        ...
        public void initCreationFormNoAuth(String user, String pwd) throws Exception {
            mockMvc.perform(get("/beers/new").with(httpBasic(user, pwd)))
                    .andExpect(status().isForbidden());
        }

        @Test
        public void initCreationFormNoAuth() throws Exception {
            mockMvc.perform(get("/beers/new"))
                    .andExpect(status().isUnauthorized());
        }
    }

    @DisplayName("Init Find Form")
    @Nested
    class FindForm {

        @ParameterizedTest(name = "#{index} with [{arguments}]")
        @MethodSource("guru.sfg.brewery.web.controllers.BeerControllerIT#getStreamAllUsers")
        public void findBeersFormAuth(String user, String pwd) throws Exception {
        ...
        @Test
        public void findAllWithAnonimous() throws Exception {
